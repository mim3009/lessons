<?php
	...
	abstract class Modules{
		...
		protected function getAuthUser(){
			...
			if(isset($_SESSION["error_auth"]) == 1){
		...
		protected function getBlogArticles($articles, $page){
			...
			for($i = $start; $i < $end; $i++){
				...
				$sr["source"] = $this->config->source . $articles[$i]["image_src"];
		...
		protected function getMainArticle(){
			$sr["source"] = $this->config->source . "1.jpg";
			return $this->getReplaceTemplate($sr, "main_article");
		}
