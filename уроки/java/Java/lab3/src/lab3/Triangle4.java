...
public class Triangle4 extends Shape {
	...
	public Triangle4(int x, int y, int dx1, int dx2, int dx3,
		int dy1, int dy2, int dy3, int k, int r, int l, int j, int t, int e) {
	super(x, y);
	...
	public void draw (Graphics canvas) {
		...
		canvas.fillRect(getStartPoint().x,getStartPoint().y+5, l, j);
		canvas.fillRect(getStartPoint().x-118,getStartPoint().y+23, t, e);
	}
